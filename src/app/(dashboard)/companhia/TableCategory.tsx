...
export  function TableCategory({categories} : CategoryListProps) {
    ...
    return (
        <>
        <Table>
            <TableCaption>Lista de companhias de seguros</TableCaption>
            <TableHeader>
                <TableRow>
            ...
            <TableBody>
                {categories.map((cat, index) => (
                    <TableRow key={cat.id}>
                        ...
                        <TableCell>
                            <PopoverSettingButton category={cat.name} id={cat.id}>
